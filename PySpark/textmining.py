...
df_pro_desc = pd.read_csv('../input/product_descriptions.csv')[:66000] #update here
...
def str_stem(s):
    if isinstance(s, str):
        ...
        #it takes s and replace it with lower cases.
        s = s.lower()
        #it takes s and replace it with the second term in the code.
        s = s.replace("  "," ")
